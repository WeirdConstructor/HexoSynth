            ...
            ui_st.fun(
                ...
                move |env: &mut Env, _argc: usize| {
                    ...
                    let model = match &name[..] {
                        ...
                        "B1" => conf_clone.param_set.b[0].clone(),
                        "B2" => conf_clone.param_set.b[1].clone(),
                        "B3" => conf_clone.param_set.b[2].clone(),
                        "C1" => conf_clone.param_set.c[0].clone(),
                        "C2" => conf_clone.param_set.c[1].clone(),
                        "C3" => conf_clone.param_set.c[2].clone(),
                        "D1" => conf_clone.param_set.d[0].clone(),
                        "D2" => conf_clone.param_set.d[1].clone(),
                        "D3" => conf_clone.param_set.d[2].clone(),
                        "E1" => conf_clone.param_set.e[0].clone(),
                        "E2" => conf_clone.param_set.e[1].clone(),
                        "E3" => conf_clone.param_set.e[2].clone(),
                        "F1" => conf_clone.param_set.f[0].clone(),
                        "F2" => conf_clone.param_set.f[1].clone(),
                        "F3" => conf_clone.param_set.f[2].clone(),
